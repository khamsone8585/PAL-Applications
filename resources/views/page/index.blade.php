...
<head>
    ...
    <!-- Favicons -->
    <link href="{{asset('assets/static/favicon.png')}}" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        ...
        <div class="logo me-auto">
            ...
            <a href="index.html"><img src="assets/img/pal_logo.png" alt="" class="img-fluid"></a>
        </div>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="carousel-inner">
            ...
            <img src="./assets/img/slide/slide1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="./assets/img/slide/slide2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="./assets/img/slide/slide3.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="./assets/img/slide/slide4.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
        </div>
    </section><!-- End Hero -->
        ...
        <section id="ourclient" class="our-client">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="row">
                    ...
                    <div class="sponsor-feature"><img alt="" src="./assets/img/Client/Client1.jpeg" style="width: 200px;" /></div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                    <div class="sponsor-feature"><img alt="" src="./assets/img/Client/Client2.jpeg" style="width: 155px;" /></div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                    <div class="sponsor-feature"><img alt="" src="./assets/img/Client/Client3.jpeg" style="width: 200px;" /></div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                    <div class="sponsor-feature"><img alt="" src="./assets/img/Client/Client4.jpeg" style="width: 200px;" /></div>
                    </div>
                </div>
                </div>
                <div class="item">
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                    <div class="sponsor-feature"><img alt="" src="./assets/img/Client/Client5.jpeg" style="width: 160px;" /></div>
                    </div>
                </div>
                </div>
            </div>
    ...
    <footer id="footer">
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 footer-contact">
                ...
                Sisattanak District, Vientiane Capital<br>
                Lao PRD <br><br>
                <strong>Phone:</strong> +856 21 263962<br>
            ...
            <div class="col-lg-3 col-md-6 footer-links">
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="#">Water Quality Analysis</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="#">Noise Level Measurement</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="#">Calibration Service</a></li>
        ...
        <div class="me-md-auto text-center text-md-center">
            <div class="copyright">
            &copy; Copyright <strong><span>PAL</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
            Designed by <a href="http://bdb.com.la">bdb.com.la</a>
            </div>
        </div>
